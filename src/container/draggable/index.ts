...
type DraggableConstructor<T = any> = new (o: T) => Omit<DraggableMouseBase & DraggablePointerBase & DraggableTouchBase, keyof DraggableCoreInstance>

export default function Draggable<T extends DraggableConstructor, O = T extends new (o: infer O1) => any ? O1 : never>(Base: T) {
